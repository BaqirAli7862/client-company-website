    ...
    <div class="container-fluid header bg-primary p-0 mb-5">
        <div class="row g-0 align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 p-5 wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-4 text-white mb-5">Explor your Dreams Overseas</h1>
                <div class="row g-4">
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            <h2 class="text-white mb-1" data-toggle="counter-up">2000</h2>
                            <p class="text-light mb-0">Trusted Clients</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            <h2 class="text-white mb-1" data-toggle="counter-up">1000</h2>
                            <p class="text-light mb-0">Employee</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item position-relative">
                        <div class="img-fluid"><img class="img-front"src="img/course-selection.webp"alt=""></div>
                        <div class="owl-carousel-text">
                            <!-- <h1 class="display-1 text-white mb-0"></h1> -->
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                       <div class="img-fluid"><img class="img-front" src="img/university.WEBP" alt=""></div>
                        <div class="owl-carousel-text">
                            <!-- <h1 class="display-1 text-white mb-0"></h1> -->
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <div class="img-fluid"><img class="img-front" src="img/service-1.webp" alt=""></div>
                        <div class="owl-carousel-text">
                            <!-- <h1 class="display-1 text-white mb-0"></h1> -->
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded w-75 align-self-end" src="img/image6.jpeg" alt="">
                        <img class="img-fluid rounded w-50 bg-white pt-3 pe-3" src="img/image7.jpeg" alt="" style="margin-top: -25%;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="d-inline-block border rounded-pill py-1 px-4">About Us</p>
                    <h1 class="mb-4">Provides our Experts to Generate Great visa</h1>
                    <p>We provide expert team to create great value for Student and Employment Visa. Our certified & reliable Student and Employment Visa Consultant professionals can help you get a positive decision on your case.</p>
                    <p class="mb-4">We provide Student and Employment Visa services in all different areas of countries.</p>
                    <p><i class="far fa-check-circle text-primary me-3"></i>Student Services</p>
                    <p><i class="far fa-check-circle text-primary me-3"></i>Visa Assistance</p>
                    <p><i class="far fa-check-circle text-primary me-3"></i>Pre Departure and After Arrival</p>
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-3" href="https://emergingconsulting.com/blog/">Read More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p>We make the visa process faster. Our primary goal has been to provide Visa Services to all Major Countries,</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-Kyrgyzstan" src="img/image10.png"></img>
                        </div>
                        <img class="country" src="img/image16.jpeg" alt=""></img>
                        <h4 class="mb-3">Study in Kyrgyzstan</h4>
                        <p class="mb-4">Kyrgystan is a fascinating and enchanting nation of different races, cultures and religions, co-existing in harmony in a tropical paradise in the heart of Southeast Asia.</p>
                        <a class="btn" href="Study-in-Kyrgyzstan.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-Malaysia" src="img/image11.png"></img>
                        </div>
                        <img class="country" src="img/image9.jpeg"></img>
                        <h4 class="mb-3">Study in Malaysia</h4>
                        <p class="mb-4">Malaysia is a fascinating and enchanting nation of different races, cultures and religions, co-existing in harmony in a tropical paradise in the heart of Southeast Asia.</p>
                        <a class="btn" href="Study-in-Malaysia.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo" src="img/uk-log.png" ></img>
                        </div>
                        <img  class="country" src="img/image17.jpeg" alt=""></img>
                        <h4 class="mb-3">Study in UK</h4>
                        <p class="mb-4">Home to the world's most outstanding educational facilities, the UK boasts of institutes globally ranked highest through the years.</p>
                        <a class="btn" href="Study-in-UK.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-Canada" src="img/image13.png"  ></img>
                        </div>
                        <img class="country" src="img/canada.jpeg" alt=""></img>
                        <h4 class="mb-3">Study in Canada</h4>
                        <p class="mb-4">For decades, international students have moved to study abroad in Canada for higher education. The high-quality education offered here is exceptional with experiential learning. The best time to choose Canada is NOW!</p>
                        <a class="btn" href="Study-in-Canada.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-Australia" src="img/image15.png"></img>
                        </div>
                        <img class="country" src="img/image18.jpeg" alt=""></img>
                        <h4 class="mb-3">Study in Australia</h4>
                        <p class="mb-4">Australia is home to some of the finest research institutions in the world. The education provided fosters innovative, versatile, independent and critical thinking skills as you grow in the field of your choice.</p>
                        <a class="btn" href="Study-in-Australia.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-USA" src="img/image14.png"></img>
                        </div>
                        <img  class="country" src="img/image19.jpeg" alt=""></img>
                        <h4 class="mb-3">Study in USA</h4>
                        <p class="mb-4">The top universities provide highly accredited professors, advanced technology and research facilities. International students planning to study in the US can look forward to the American campus lifestyle.</p>
                        <a class="btn" href="Study-in-USA.php"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                <div class="h-100 bg-light rounded d-flex align-items-center p-5">
                    ...
                    <div class="ms-4">
                        ...
                        <h5 class="mb-0" style="font-weight: 100;">dreamwayeducational<br>consultant@gmail.com</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
