...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Foundation Courses</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <main id="main" class="site-main">
            <article id="post-14026" class="post-14026 page type-page status-publish hentry">
                <header class="single-entry-header themestek-hide">
                    <h2 class="entry-title" style="text-align: center;">Foundation Courses</h2><br>
                </header><!-- .entry-header -->
                <div class="entry-content">
                    ...
                    <h2>What are International Foundation Programmes?</h2>
                    <p>International Foundation Programmes are meant to assist you prepare for first-year admission to undergraduate degrees at world-class institutions. In just 12 months, you will be able to incorporate academic study, skills in studying, intense English language preparation, and cultural exposure in under 12 months.&nbsp;</p>
                    <p>These gateway degrees, sometimes known as ‘year zero’ programs, are incorporated into degree programs and prepare you to succeed in your chosen degree.&nbsp;</p>
                    <h2>Is this Programme Right for You?</h2>
                    <p>Yes, a foundation year can be an excellent investment of time for international students looking to study abroad. These programmes will provide you with the necessary skills and preparation to excel in your undergraduate degree.&nbsp;</p>
                    <p>By taking an extra year to adjust to a new environment and academic expectations, you can dedicate more time and energy to your studies, leading to better grades. In addition, a foundation year can be a valuable investment for you considering the large expenses involved in studying abroad.&nbsp;</p>
                    <p>That way, you can get the most out of your studies and position yourself for success in the future by getting prepared and assured.</p>
                    <h2>Which Pathway Should You Study?</h2>
                    <p>We offer an array of exciting pathways that cover almost all undergraduate degrees offered in UK universities.&nbsp;</p>
                    <ul>
                        <li aria-level="1">Applied Science</li>
                        <li aria-level="1">Art, Design, and Media</li>
                        <li aria-level="1">Business and Law</li>
                        <li aria-level="1">Computing</li>
                        <li aria-level="1">Engineering</li>
                        <li aria-level="1">Humanities and Social Science</li>
                    </ul>
                    <p>And many more. Our programmes are designed to equip you with the necessary skills and knowledge to excel in your field of study. With our expert guidance and&nbsp;<a href="contact.php"><b>support</b></a>, you can achieve your academic and career goals with ease.</p>
                    <h2>What are the IELTS Requirements?</h2>
                    <p>As an international student, you’ll need to meet the IELTS requirements for your chosen Foundation Programme. These requirements vary, but you’ll need to prove your proficiency in English to continue your studies.&nbsp;</p>
                    <p>Sometimes, meeting linguistic standards is not always the sole requirement. It’s essential to prepare in advance, as your IELTS score can make a significant difference. Generally, a minimum score of 4.5 to 5.0 is required but check with your chosen institution for their specific requirements.</p>
                    <!-- apply now -->
