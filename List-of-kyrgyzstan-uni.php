...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="display-3 text-white mb-3 animated slideInDown">List of Kyrgystan Universities</h3>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p>We Partner With Top-Rated Universities In Kyrgystan</p>
                <h1>List of Kyrgystan Universities</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Kyrgyzstan.php"><img class="country" src="img/kyuni1.png" alt=""></img></a>
                        
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Kyrgyzstan.php"><img class="country" src="img/kyuni2.png"></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Kyrgyzstan.php"><img  class="country" src="img/kyuni3.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Kyrgyzstan.php"><img class="country" src="img/kyuni4.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Kyrgyzstan.php"><img class="country" src="img/kyuni5.png" alt=""></img></a>
                    </div>
                </div>
