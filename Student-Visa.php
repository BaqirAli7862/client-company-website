...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Student Visa</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <main id="main" class="site-main">
            <article id="post-14356" class="post-14356 page type-page status-publish hentry">
                ...
                <div class="entry-content">
                    ...
                    <p style="text-align: center;">We are here to help you with your student visa application! <br>Student visa is a validation by the immigration authorities on passport that indicates that you are allowed to enter the country and stay to study. <br>Generally, you begin your student visa application once you receive confirmation of enrollment at chosen university. That’s’ why it suggested to apply for admission earliest as possible, so visa application can be initiated soon as possible, as time can vary on outcome. <br>There are some steps to apply for a student visa and how you complete these steps may vary according to intend study destination. Vibrant Educational Consultant will direct and assist you with your visa application forms.</p>
                    ...
                    <figure><img decoding="async" width="500" height="340" src="img/service-1.webp" alt="" loading="lazy" data-id="14336"></figure>
                    <h3>Educational Counseling</h3>
                    <p>Educational Counselling Program equips candidates with in-depth understanding of the numerous issues and pressures facing pupils today. With a solid background in this area, candidates are better able to communicate with pupils of all cultures, socioeconomic levels, and learning abilities.</p>
                    <figure><img decoding="async" width="500" height="340" src="img/course-selection.webp" alt="" loading="lazy" data-id="14337"></figure>
                    <h3>Course Selection</h3>
                    <p>During priority registration, you may register in courses in your major(s) for which you have prerequisites and in any courses for which you have prerequisites, and which do not have limited enrolment.</p>
                    <figure><img decoding="async" width="500" height="340" src="img/documentation.webp" alt="" loading="lazy" data-id="14363"></figure>
                    <h3>Pre-Visa Counseling &amp; Documentation</h3>
                    <p>The most effective way of testing your English conversation skills is face-to-face. IELTS AND DUOLINGO is the most widely accepted English language test with a one-on-one speaking test to assess your English language communication skills.</p>
                    <figure><img decoding="async" width="500" height="340" src="img/visaform.jpg" alt="" loading="lazy" data-id="14364"></figure>
                    <h3>Visa File Preparation </h3>
                    <p>During priority registration, you may register in courses in your major(s) for which you have prerequisites and in any courses for which you have prerequisites, and which do not have limited enrolment.</p>
                    <figure><img decoding="async" width="500" height="340" src="img/visa-application-form.jpg" alt="" loading="lazy" data-id="14371"></figure>
                    <h3>Apply for the Visa </h3>
                    <p>The first step is to determine which visa type you need, and check whether you’re eligible to apply for it. Our team members assist you with the documents that you’ll have to submit along with your application, and assist you that how long the application might take and fees you’ll have to pay. Each application must comply with the guidelines applicable for your visa category</p>
                    <figure><img decoding="async" width="500" height="340" src="img/prepare-interviews-featured.png" alt="" loading="lazy" data-id="14374"></figure>
                    <h3>Interview Preparation </h3>
                    <p>A Visa interview is a way by which the visa officers check the credibility of the student. It is a crucial part of a student’s visa application. Our expert guides have helped students with their remarkable strategies, which helped them succeed in their visa interviews.</p>
                    <figure><img decoding="async" width="500" height="340" src="img/bookappointment.jpg" alt="" loading="lazy" data-id="14373"></figure>
                    <h3>Book an Appointment </h3>
                    <p>Once we’ve booked your appointment, you’ll receive an appointment confirmation email along with the letter of appointment. Your fingerprints and photo taken at a Visa Application Centre. This is known as ‘biometric information’.</p>
                    <!-- apply now -->
