...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="display-3 text-white mb-3 animated slideInDown">Countrys</h3>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" style="font-weight: bold; color: dimgray;"href="#">Services</a></li>
                    <li class="breadcrumb-item"><a class="text-white" style="font-weight: bold; color: dimgray;" href="#">Education visa</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page"><a class="text-white" style="font-weight: bold; color: dimgray;" href="#">Contact Us</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Countrys</p>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <img class="country-logo-UK" src="img/uk-log.png" ></img>
                        </div>
                ...
                <!-- add three more -->
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                                <img class="country-logo-South" src="img/download5.png"></img>
                            </div>
                            <img class="country" src="img/download7.jfif" alt=""></img>
                            <h4 class="mb-3">Study in South cypress</h4>
                            <p class="mb-4">Universities in South Cyprus provide quality education at quite affordable cost than most other parts of Europe. Study in a safe and friendly environment: The environment is safe and friendly.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                                <img class="country-logo-Dubai" src="img/download3.png"></img>
                            </div>
                            <img class="country" src="img/download6.jfif"></img>
                            <h4 class="mb-3">Study in Dubai</h4>
                            <p class="mb-4">International students are permitted to study in Dubai and pursue any course of their choice. After being accepted by a university or higher education provider, you will need to apply for a student visa.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                                <img class="country-logo" src="img/download2.png" ></img>
                            </div>
                            <img  class="country" src="img/download4.jfif" alt=""></img>
                            <h4 class="mb-3">Study in Finland</h4>
                            <p class="mb-4"> The universities offer academic degrees on Bachelor's, Master's and Doctoral level, whereas the UAS's offer more practically oriented Bachelor's and Master's degrees.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/ontario-tech-university.png" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/university-of-houston.png" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Houston</h5>
                            <p class="text-primary">University</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/segi-university.png" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Segi</h5>
                            <p class="text-primary">University</p>
