...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="display-3 text-white mb-3 animated slideInDown">List of Finland Universities</h3>
        </div>
    </div>
    <!-- Page Header End -->


    <!-- start the finland uni list -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Universities</p>
                <p>We Partner With Top-Rated Universities In Finland</p>
                <h1>List of Finland Universities</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img class="country" src="img/finuni1.png" alt=""></img></a>
                        
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img class="country" src="img/finuni2.png"></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img  class="country" src="img/finuni3.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img class="country" src="img/finuni4.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img class="country" src="img/finuni5.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Finland.php"><img  class="country" src="img/finuni6.png" alt=""></img></a>
                    </div>''
                </div>
                <!-- add three more -->
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni7.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni8.jpg"></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img  class="country" src="img/finuni9.png" alt=""></img></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni10.png" alt=""></img></a>
                            
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni11.png"></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img  class="country" src="img/finuni12.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni13.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img class="country" src="img/finuni14.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Finland.php"><img  class="country" src="img/finuni15.png" alt=""></img></a>
                        </div>''
                    </div>
                    <!-- add three more -->
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni16.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni17.png"></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img  class="country" src="img/finuni18.jpg" alt=""></img></a>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni19.png" alt=""></img></a>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni20.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni21.jpg"></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img  class="country" src="img/finuni22.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni23.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni24.png" alt=""></img></a>
                            </div>
                        </div>
                        <!-- add three more -->
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni25.jpg" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni26.png"></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img  class="country" src="img/finuni27.png" alt=""></img></a>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni28.png" alt=""></img></a>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni29.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni31.png"></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img  class="country" src="img/finuni32.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni33.png" alt=""></img></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                <a href="Study-in-Finland.php"><img class="country" src="img/finuni34.png" alt=""></img></a>
                            </div>
                        </div>
                        <!-- apply now -->
