...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Study in South Cypress</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    <img class="img-fluid rounded w-75 align-self-end" src="img/south3.jfif" alt="">
                    <img class="img-fluid rounded w-50 bg-white pt-3 pe-3" src="img/south2.jfif" alt="" style="margin-top: -25%;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s"              style="background-color: whitesmoke; color: #000; font-family:          sans-serif; font-size: medium;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Study in South Cypress</p>
                <h4 style="text-align:left;" class="themestek-custom-heading ">Study in South Cypress</h4>

                <div class="wpb_wrapper">
                    <p>Affordable Tuition Fee: Universities in South Cyprus provide quality education at quite affordable cost than most other parts of Europe. Study in a safe and friendly environment: The environment is safe and friendly.</p>
        
                </div>

                <div class="wpb_wrapper">
                    <h4 style="text-align:left;" class="themestek-custom-heading ">Why South Cyprus?</h4>
        
                    <div class="wpb_single_image wpb_content_element vc_align_left">
                        <figure class="wpb_wrapper vc_figure">
                            <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/south4.jfif" class="vc_single_image-img attachment-full" style=" width: 140%;height: 170%; display: block;" alt="">
                            </div>
                        </figure>
                    </div>

                    <div class="wpb_wrapper">
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;</strong></span><span lang="EN-GB"><strong>Affordable Tuition Fee:</strong> Universities in South Cyprus provide quality education at quite affordable cost than most other parts of Europe.</span></p>
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;&nbsp;</strong></span><span lang="EN-GB"><strong>Study in a safe and friendly environment:</strong> The environment is safe and friendly. Compared to most parts of Europe, the crime rate in Cyprus is reasonably low. No wonder many tourists keep going there for holidays again and again.</span></p>
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang="EN-GB"><strong>Lower cost of living and study than other European countries:</strong> Living, eating and transport in Cyprus is much cheaper as compared to other European countries. Cyprus offer very affordable living conditions for students.</span></p>
                        <p class="yiv0915099779MsoNormal"><strong><span lang="EN-GB">English qualification is compulsory.</span></strong></p>
                        <h4>Quality Education Provider:</h4>
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang="EN-GB">
                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                <figure class="wpb_wrapper vc_figure">
                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/south1.jfif" class="vc_single_image-img attachment-full" style=" width: 170%;height: 170%; display: block;" alt="">
                                    </div>
                                </figure>
                            </div>
                            Cyprus education providers allow quality education at international standards in English. Internationally recognized undergraduate and graduate programs serving all interests are provided to the students. Currently, thousands of international students from various countries are studying in Cyprus. In this way, students enjoy additional advantage of learning in a multicultural environment. World class standard of Education with Excellent facilities for social, cultural and sports activities are provided.</span></p>
                            <h4>Easier Study Visa Requirements:</h4>
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang="EN-GB">
                                <div class="wpb_single_image wpb_content_element vc_align_left">
                                    <figure class="wpb_wrapper vc_figure">
                                        <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/south5.jfif" class="vc_single_image-img attachment-full" style=" width: 170%;height: 170%; display: block;" alt="">
                                        </div>
                                    </figure>
                                </div>
                                Getting a visa to Cyprus as a student is not very difficult. Just have the right documents and you will not be refused. You can contact us for more information.</span></p>
                            ...
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></span><span lang="EN-GB"><strong>Pleasant climate and beautiful beaches:</strong> Cyprus has one of the best beaches in the world. With its warm, dry summers and mild winters Cyprus is a Pleasant place to stay.</span></p>
                            ...
                            <p>&nbsp;</p>
                            <p>Ready to get started?&nbsp;<a href="course-registration-from.php">Book a FREE appointment</a>&nbsp;to discuss your study options in South Cypress.</p>
