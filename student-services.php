...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Employment Permit</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <main id="main" class="site-main">
            <article id="post-14333" class="post-14333 page type-page status-publish hentry">
                <header class="single-entry-header themestek-hide">
                    <h2 class="entry-title">Student Services</h2>	
                </header><!-- .entry-header -->
                <div class="entry-content">
                    ...
                    <figure><img decoding="async" width="600" height="400" src="img/course-selection.webp" alt="" loading="lazy" data-id="14337"></figure>
                    ...
                    <figure><img decoding="async" width="600" height="400" src="img/university.webp" alt="" loading="lazy" data-id="14342"></figure>
                    <h3>University Selection</h3>
                    <p>A university is an institution of higher (or tertiary) education and research which grants academic degrees in various subjects and typically provides undergraduate education and postgraduate education. The word “university” is derived from the Latin universitas magisterium et scholarism, which roughly means “community of teachers and scholars.”</p>
                    <figure><img decoding="async" width="600" height="400" src="img/university.webp" alt="" loading="lazy" data-id="14342"></figure>
                    <h3>Scholarships</h3>
                    <p>Scholarships and grants are types of gift aid that do not have to be repaid. Limited number of fully funded and partially funded scholarships are available for Ireland, UK, Europe and Australia.</p>
                    <figure><img decoding="async" width="600" height="400" src="img/course-selection.webp" alt="" loading="lazy" data-id="14337"></figure>
                    <h3>Offers &amp; Admissions</h3>
                    <p>University admission or college admission is the process through which students enter tertiary education at universities and colleges. Systems vary widely from country to country, and sometimes from institution to institution.</p>
                    <!-- apply now -->
