...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="display-3 text-white mb-3 animated slideInDown">List of South Cypress Universities</h3>
        </div>
    </div>
    <!-- Page Header End -->


    <!-- list of south cypress uni -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Universities</p>
                <p>We Partner With Top-Rated Universities In South Cypress</p>
                <h1>List of South Cypress Universities</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni1.png" alt=""></img></a>
                        
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni2.jfif"></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img  class="country" src="img/southuni3.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni4.png" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni5.jfif" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-south-cypress.php"><img  class="country" src="img/southuni6.png" alt=""></img></a>
                    </div>''
                </div>
                <!-- add three more -->
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni7.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-south-cypress.php"><img class="country" src="img/southuni8.png"></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-south-cypress.php"><img  class="country" src="img/southuni9.png" alt=""></img></a>
                        </div>
                    </div>
                        <!-- apply now -->
