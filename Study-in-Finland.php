...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Study in Finland</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    <img class="img-fluid rounded w-75 align-self-end" src="img/finland5.jfif" alt="">
                    <img class="img-fluid rounded w-50 bg-white pt-3 pe-3" src="img/finland2.jfif" alt="" style="margin-top: -25%;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s"              style="background-color: whitesmoke; color: #000; font-family:          sans-serif; font-size: medium;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Study in Finland</p>
                <h4 style="text-align:left;" class="themestek-custom-heading ">Study in Finland</h4>

                <div class="wpb_wrapper">
                    <p>Finland is a country situated in Northern Europe and joins Sweden, Denmark, Iceland, and Norway to make up the Nordic countries. Finland is an EU member country since 1995 and a parliamentary republic with the government located in the capital city of Helsinki. Finland is home to 5.54 million inhabitants. Most of the population is concentrated in the Southern parts of the country in the biggest cities such as Helsinki, Tampere, and Turku. Finland is ranked as one of the top 5 countries in the world with the highest standards of living and equality. The Finnish welfare state is commendable for its upkeep of all its residents’ well-being.
                        <div class="wpb_single_image wpb_content_element vc_align_left">
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/finland3.jfif" class="vc_single_image-img attachment-full" style=" width: 140%;height: 170%; display: block;" alt="">
                                </div>
                            </figure>
                        </div>
                ...
                <div class="wpb_wrapper">
                    <h4 style="text-align:left;" class="themestek-custom-heading ">Why Study in Finland?</h4>
        
                    <div class="wpb_single_image wpb_content_element vc_align_left">
                        <figure class="wpb_wrapper vc_figure">
                            <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/finland1.jfif" class="vc_single_image-img attachment-full" style=" width: 140%;height: 170%; display: block;" alt="">
                            </div>
                        </figure>
                    </div>

                    <div class="wpb_wrapper">
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;</strong></span><span lang="EN-GB">Finland is a human-scaled, cosy country, with cities and towns designed for people, not just cars. Rush-hours are a rarity. <br>Our higher education institutions are small enough to operate functionally and effectively. They are all internationally oriented with special regional features, and you can choose between very different study environments ranging from larger urban campuses to close-to-nature campuses. <br>Higher education institutions are highly autonomous, but largely funded by the Ministry of Education and Culture. Therefore the Ministry also closely oversees the quality of teaching. These efficiently managed institutions:</p>
                        <h4>Quality Education Provider:</h4>
                        <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang="EN-GB">
                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                <figure class="wpb_wrapper vc_figure">
                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/finland.jfif" class="vc_single_image-img attachment-full" style=" width: 170%;height: 170%; display: block;" alt="">
                                    </div>
                                </figure>
                            </div>
                            Finland education providers allow quality education at international standards in English. Internationally recognized undergraduate and graduate programs serving all interests are provided to the students. Currently, thousands of international students from various countries are studying in Finland. In this way, students enjoy additional advantage of learning in a multicultural environment. World class standard of Education with Excellent facilities for social, cultural and sports activities are provided.</span></p>
                            <h4>Easier Study Visa Requirements:</h4>
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang="EN-GB">
                                <div class="wpb_single_image wpb_content_element vc_align_left">
                                    <figure class="wpb_wrapper vc_figure">
                                        <div class="vc_single_image-wrapper   vc_box_border_grey"><img loading="lazy" decoding="async" src="img/finland4.jfif" class="vc_single_image-img attachment-full" style=" width: 170%;height: 170%; display: block;" alt="">
                                        </div>
                                    </figure>
                                </div>
                                Getting a visa to Finland as a student is not very difficult. Just have the right documents and you will not be refused. You can contact us for more information.</span></p>
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;</strong></span><span lang="EN-GB"><strong>Work Rights on Student Visa:</strong> Students are allowed to work 20 hours week on student visa</span></p>
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></span><span lang="EN-GB"><strong>Pleasant climate and beautiful beaches:</strong> Finland has one of the best beaches in the world. With its warm, dry summers and mild winters Cyprus is a Pleasant place to stay.</span></p>

                            <h4>Excellence awaits you</h4>
                            <p class="yiv0915099779MsoNormal"><span lang="EN-GB">·&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></span><span lang="EN-GB">All in all, it’s fair to say that Finland seems to excel on all levels. It’s got a great education system, an honest and warm society, a great environment and well-chosen values. Living and studying in Finland is one of the best choices you can make. It will be a great experience and you will discover what a great human society looks like. Best of luck and make the most out of it!</p>
                            ...
                            <p>&nbsp;</p>
                            <p>Ready to get started?&nbsp;<a href="course-registration-from.php">Book a FREE appointment</a>&nbsp;to discuss your study options in Finland.</p>
