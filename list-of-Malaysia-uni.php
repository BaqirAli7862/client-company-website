...
<div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3_1 ht_ctc_animation no-animations" id="ht-ctc-chat" style="position: fixed; bottom: 15px; left: 15px; cursor: pointer;z-index: 99999999;">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="display-3 text-white mb-3 animated slideInDown">List of Canada Universities</h3>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p>We Partner With Top-Rated Universities In Malaysia</p>
                <h1>List of Malaysia Universities</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni1.png" alt=""></img></a>
                        
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni2.png"></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img  class="country" src="img/maluni3.jpeg" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni4.jpeg" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni5.jpeg" alt=""></img></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <a href="Study-in-Malaysia.php"><img  class="country" src="img/maluni6.png" alt=""></img></a>
                    </div>''
                </div>
                <!-- add three more -->
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni7.jpeg" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni8.jpeg"></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img  class="country" src="img/maluni9.png" alt=""></img></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni10.png" alt=""></img></a>
                            
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni11.png"></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img  class="country" src="img/maluni12.png" alt=""></img></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            <a href="Study-in-Malaysia.php"><img class="country" src="img/maluni13.png" alt=""></img></a>
                        </div>
                    </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
